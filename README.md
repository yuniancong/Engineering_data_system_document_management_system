...
- 案卷目录_YYYY-MM-DD.docx
- 档案移交书_YYYY-MM-DD.docx

**注意事项**：
- Word文档使用docx.js库在浏览器中生成，无需服务器
...
**功能说明**：
- 系统使用docx.js库动态生成Word文档，无需依赖模板文件
- templates文件夹中的文件仅作为格式参考，不参与导出过程
- 导出的Word文档完全由系统根据数据动态生成，符合GB 50328-2014标准
